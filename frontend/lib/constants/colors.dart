...
class AppColors {
  ...
  static const Color calendarEventBackground = Color(0x1AF9C846);
  static const Color calendarEventBorder = Color(0xFFF9C846);
  static const Color calendarEventBadge = Color(0xFFF9C846);
