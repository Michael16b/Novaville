...
class CsvDropTexts {
  ...
  static const invalidOrMalformed = 'Le fichier CSV est invalide ou mal formaté.';
  ...
  static const roleLowercase = 'Le rôle doit être en minuscule (ex: citizen, elected, agent)';
  static const invalidRoleValue = 'Valeur invalide. Valeurs autorisées: citizen, elected, agent';
