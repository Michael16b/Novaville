...
class AgendaTexts {
  ...
  static const noEventsDescription = "Il n'y a pas encore d'événement prévu.";
  ...
  /// Invalid date error.
  static const invalidDate = 'La date de fin doit être après la date de début';
  ...
  static const fetchThemesError = 'Erreur lors du chargement des thématiques';

  /// Error loading events.
  static const fetchEventsError = 'Erreur lors du chargement des événements';

  /// Error loading event detail.
  static const fetchEventError = "Erreur lors du chargement de l'événement";

  /// Error creating an event.
  static const createEventError = "Erreur lors de la création de l'événement";
  ...
  static const calendarExportError = "Impossible d'ouvrir le lien de l'agenda";
}
