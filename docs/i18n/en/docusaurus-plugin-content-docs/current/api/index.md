...
- **[Authentication](./auth/)**: Login and token refresh endpoints.
- **[Users](./users/)**: User account, role, and profile management.
- **[Events](./events/)**: Municipal event planning and participation.
- **[Reports](./reports/)**: Incident reporting and processing.
...
- **OpenAPI / Swagger (backend)**: the backend exposes a full OpenAPI/Swagger UI (schemas, models, examples) available locally at `http://localhost:8000/api/docs/` when the backend is running.
