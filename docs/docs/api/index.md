...
- **[Authentification](./auth/)** : Connexion et rafraîchissement des tokens.
- **[Utilisateurs](./users/)** : Gestion des comptes utilisateurs et profils.
- **[Événements](./events/)** : Création et participation aux événements de la commune.
- **[Rapports](./reports/)** : Signalement et suivi des anomalies ou incidents urbains.
...
3. Ouvrez une issue sur [GitHub](https://github.com/Michael16b/Novaville/issues)
